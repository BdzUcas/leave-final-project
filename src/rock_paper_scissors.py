...
def choice_gui():
    ...
    arcade_game_image = tk.PhotoImage(master=choice_gui,file="Images/arcade_game.png")
...
def win_gui(choice: int, computer_choice: int, win_message: str, winner = False, bot_winner = False):
    ...
    title.pack()
    title.place(relx=0.5,rely=0.2,anchor=tk.CENTER)
    rock = tk.PhotoImage(master=win_gui,file="Images/rock.png")
    paper = tk.PhotoImage(master=win_gui,file="Images/paper.png")
    scissors = tk.PhotoImage(master=win_gui,file="Images/scissors.png")
    ...
    vs_image = tk.PhotoImage(master=win_gui,file='Images/vs.png')
    ...
    next_img = tk.PhotoImage(master=win_gui,file="Images/continue.png")
